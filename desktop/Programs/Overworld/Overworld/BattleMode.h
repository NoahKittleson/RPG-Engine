...
{
public:
    BattleMode(std::list<Character> enemies);
...
private:
    ...
    std::list<Character> combatants;//alternatively, could keep party and enemies separtate, would make iterating a bit harder though...
    std::list<Character>::iterator currentChar {combatants.begin()};
